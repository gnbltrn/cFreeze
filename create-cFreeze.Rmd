...
usethis::create_package(
  ...
  fields = list(
    ...
    Version = "1.0",
    Title = "No Freeze for Corn Planting",
    Description = "To understand the risk of chilling or freeze damage when planting corn.",
...
usethis:::use_description_field(
  "URL",
  "https://github.com/gnbltrn/cFreeze/tree/main"
)
```
