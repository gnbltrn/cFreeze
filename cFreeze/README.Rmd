...
All weather data used by this package is extracted directly from IEM using the apsimx package.  cFreeze uses the minimum temperature (mint) reported by IEM.  No data is stored or kept by the cFreeze package.
...
For detailed information on each of the 5 cFreeze functions, consult the Reference section of the Freeze website, or follow this link: 

https://gnbltrn.github.io/cFreeze_Package/reference/index.html

For additional examples on how to use cFreeze, please check the article "Using cFreeze Package" in the Articles section of Freeze website, or follow this link:
